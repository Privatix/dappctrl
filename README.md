[![Build Status](https://travis-ci.org/Privatix/dappctrl.svg?branch=master)](https://travis-ci.org/Privatix/dappctrl)
...
* Install [Golang](https://golang.org/doc/install) 1.12+ . Make sure that `$GOPATH/bin` is added to system path `$PATH`.
