...
VALUES
    (
        ...
        100, 1, 10, 900, 10, 100000, 10, 10, 0, '00000000-0000-0000-0000-000000000000',
        '{}'
    ),
    (
        ...
        100, 1, 10, 900, 10, 1, 10, 10, 0, '00000000-0000-0000-0000-000000000000',
        '{}'
    );
...
VALUES
    (
        ...
        '0000000000000000000000000001',
        '00000000-0000-0000-0000-000000000000',
        100, 'active', 'suspended', now(), 10000,
