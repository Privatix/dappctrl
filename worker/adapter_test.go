...
func (b *testEthBackend) PTCBalanceOf(opts *bind.CallOpts, addr common.Address) (*big.Int, error) {
	b.callStack = append(b.callStack, testEthBackCall{
		method: "PTCBalanceOf",
		caller: opts.From,
		args:   []interface{}{addr},
...
func (b *testEthBackend) PSCBalanceOf(opts *bind.CallOpts, addr common.Address) (*big.Int, error) {
	b.callStack = append(b.callStack, testEthBackCall{
		method: "PSCBalanceOf",
		caller: opts.From,
		args:   []interface{}{addr},
...
func (b *testEthBackend) PTCApprove(opts *bind.TransactOpts, addr common.Address, amount *big.Int) error {
	b.callStack = append(b.callStack, testEthBackCall{
		method: "PTCApprove",
		caller: opts.From,
...
func (b *testEthBackend) PSCAddBalanceERC20(opts *bind.TransactOpts, val *big.Int) error {
	b.callStack = append(b.callStack, testEthBackCall{
...
func (b *testEthBackend) PSCReturnBalanceERC20(opts *bind.TransactOpts, val *big.Int) error {
	b.callStack = append(b.callStack, testEthBackCall{
...
func (b *testEthBackend) setTransaction(t *testing.T, opts *bind.TransactOpts, input []byte) {
...
func (b *testEthBackend) GetTransactionByHash(context.Context, common.Hash) (*types.Transaction, bool, error) {
