...
const (
	// OpenVpnConfServerFullExample almost standard OpenVpn server configuration file for tests
	OpenVpnConfServerFullExample = `#################################################
...
# Added manual
ping-restart 10### test comment  ###
ping 10# test comment
connect-retry 2 120 # test comment
`

	// OpenVpnConfServerFakeCertificate does not have a certificate
	OpenVpnConfServerFakeCertificate = `#################################################
# Sample OpenVPN 2.0 config file for            #
# multi-client server.                          #
#                                               #
# This file is for the server side              #
...
connect-retry 2 120 # test comment
`
	// CertValidExample valid certificate for tests
	CertValidExample = `-----BEGIN CERTIFICATE-----
