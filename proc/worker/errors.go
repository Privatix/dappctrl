...
func init() {
	errors.InjectMessages(errors.Messages{
		...
		ErrInvalidJob:                   "unexpected job type or job related type",
		...
		ErrWrongLogNonIndexedArgsNumber: "wrong number of ethereum log's non-indexed arguments",
		...
		ErrPSCOfferingSupply:            "could not get an offering supply (PSC)",
		...
		ErrPSCUncooperativeClose:        "could not uncooperatively close a channel (PSC)",
		ErrEthGetTransaction:            "could not get transaction from ethereum",
		ErrEthTxInPendingState:          "unexpected pending state of a transaction",
		ErrEthRetrieveBalance:           "could not get ethereum balance",
		ErrEthLogChannelMismatch:        "channel does not correspond to ethereum log",
		...
		ErrChannelReceiptBalance:        "receipt balance is greater than a deposit",
		ErrInvalidChannelStatus:         "can not be applied to a channel with the current channel status",
		ErrInvalidServiceStatus:         "can not be applied to a channel with the current service status",
		...
		ErrInvalidEndpoint:              "endpoint does not correspond to the schema",
